...
class pf_Data_OfferingsViewDetail extends ViewDetail {

    /**
     * Detail view constructor function
     */
     ...
     */
    function pf_Data_OfferingsViewDetail() {
     ...
     */
    function display() {
        /** Following two lines required to add option of print PDF in action menu
         * which will display popup for PDF template in which we want to export data * /
        require_once('modules/AOS_PDF_Templates/formLetter.php');
        formLetter::DVPopupHtml();*/
        ...
        if (!empty($templates)) {
            echo '	<div id="popupDiv_ara" style="display:none;position:fixed;top: 39%; left: 41%;opacity:1;z-index:9999;background:#FFFFFF;">
 				<form id="popupForm" action="index.php?entryPoint=PrintDataOffering" method="post">
            ...
            foreach ($templates as $templateid => $template) {
                $js = "document.getElementById('popupDivBack_ara').style.display='none';"
                        ...
                        . "if(form!=null){form.templateID.value='" . $templateid . "';form.submit();}"
                        . "else{alert('Error!');}";
                echo '<tr height="20">

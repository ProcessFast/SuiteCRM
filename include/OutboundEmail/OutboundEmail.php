...
class OutboundEmail
{
    ...
    /**
     * Retrieve an array containing outbound emails records for all outbound email accounts 
     * which are assigned to particular user
     *
     * @param SugarBean $user
     * @return array
     */
    function getOutboundAccounts($user=NULL) {
